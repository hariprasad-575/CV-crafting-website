...
const digitRegex = /^\d+$/;
// from html code it takes data with class name:cv-form
...
//assigning values to variables using 'let'
...
// display elements
// displaying elements using 'getElementById' and assigning it to vars
...
//fetches data from lists from outer nd inner layers
...
//This function provides a convenient way to collect and organize user data from a complex form with multiple sections
const getUserInputs = () => {
    //takes data and organizes in the form needed using 'querySelectorAll'
    // achivements 
    ...
    //uses keyup event to trigger each and every field
    ...
    //returns the data in structered format as
    //fetchValues function is used to organize the data
    return {
...
//validates if true-ok else produces error
